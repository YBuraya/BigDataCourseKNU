...
#Створимо один набір даних, об'єднавши тестовий та тренувальний набори
...
#та присвоюємо змінним у наборі даних описові імена.
y_factor <- factor(data_set_y$Y)
levels(y_factor) <- activity_labels[,2]
data_set_y$Y <- y_factor

#З набору даних з кроку 4 створити другий незалежний акуратний набір даних (tidy dataset) із середнім значенням 
#для кожної змінної для кожної діяльності та кожного суб’єкту (subject).
